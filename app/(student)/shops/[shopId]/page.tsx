...
import MobileShopDetailView from '@/app/components/mobile/MobileShopDetailView';
  ...
  return (
    <>
      ...
      <div className="hidden md:block max-w-3xl mx-auto px-6 py-8">
        {/* Back to list */}
        <div className="flex items-center gap-4 mb-6 animate-fade-in text-left">
          <Link
            href="/shops"
        ...
        {/* Closed Shop Alert */}
        {shop.status === 'closed' && (
          <div className="p-4 mb-6 rounded-2xl bg-[var(--error-bg)] border border-[var(--error-border)] text-sm text-[var(--error)] flex items-center gap-3 animate-fade-in text-left">
      ...
      <div className="md:hidden block">
        <MobileShopDetailView shop={shop} />
      </div>
    </>
  );
}
