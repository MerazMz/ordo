...
export default function ShopPrintPage() {
                      ...
                      <div className="flex items-center gap-3">
                        <button
                          onClick={() => {
                            ...
                            const newBWVal = selectedFile.printOptions.copiesBW - 1;
                            const newColorVal = selectedFile.printOptions.copiesColor;
                            const total = newBWVal + newColorVal;
                            const colorType = newColorVal > 0 ? (newBWVal > 0 ? 'mixed' : 'color') : 'bw';
                        ...
                        <button
                          ...
                          className={cn(
                            ...
                            selectedFile.printOptions.orientation === opt
                              ? 'bg-[var(--accent)] text-[var(--text-inverse)] border-[var(--accent)]'
                              : 'bg-[var(--surface)] text-[var(--text-secondary)] border-[var(--border)] hover:border-[var(--border-strong)] border-[var(--border)]'
                          )}
                        >
